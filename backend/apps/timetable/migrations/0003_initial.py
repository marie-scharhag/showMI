...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('timetable', '0002_remove_document_rooms_remove_lesson_course_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courseName', models.CharField(choices=[('MI', 'Medieninformatik'), ('AI', 'Angewandte Informatik'), ('WI', 'Wirtschafts Informatik')], max_length=46)),
            ],
        ),
        migrations.CreateModel(
            name='Information',
        ...
        migrations.CreateModel(
            name='Lesson',
            fields=[
                ('lessonNr', models.IntegerField(primary_key=True, serialize=False)),
                ...
                ('timeslot', models.ManyToManyField(to='timetable.timeslot')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
